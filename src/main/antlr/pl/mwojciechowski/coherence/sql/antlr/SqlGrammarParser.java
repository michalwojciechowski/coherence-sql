...
public class SqlGrammarParser extends Parser {
	...
	public static final int
			...
			RULE_tableNameWithHint = 27, RULE_derivedTable = 28, RULE_functionCall = 29,
	...
	public static final String[] ruleNames = {
			...
			"tableSourceItem", "changeTable", "joinPart", "tableNameWithHint", "derivedTable",
	...
	public static class TableSourceItemContext extends ParserRuleContext {
		public TableNameWithHintContext tableNameWithHint() {
			return getRuleContext(TableNameWithHintContext.class, 0);
		}
			...
			switch (getInterpreter().adaptivePredict(_input, 61, _ctx)) {
					...
					enterOuterAlt(_localctx, 1);
				{
					...
					if (_la == MERGE || _la == HASH || _la == LOOP || _la == REMOTE) {
						{
							setState(519);
							((JoinPartContext) _localctx).joinHint = _input.LT(1);
							_la = _input.LA(1);
							if (!(_la == MERGE || _la == HASH || _la == LOOP || _la == REMOTE)) {
								((JoinPartContext) _localctx).joinHint = (Token) _errHandler.recoverInline(this);
							} else {
								if (_input.LA(1) == Token.EOF) matchedEOF = true;
								_errHandler.reportMatch(this);
								consume();
	...
	public static class TableNameWithHintContext extends ParserRuleContext {
		public TableNameContext tableName() {
			return getRuleContext(TableNameContext.class, 0);
		}

		public TableNameWithHintContext(ParserRuleContext parent, int invokingState) {
			super(parent, invokingState);
		}

		@Override
		public int getRuleIndex() {
			return RULE_tableNameWithHint;
		}

		@Override
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof SqlGrammarListener) ((SqlGrammarListener) listener).enterTableNameWithHint(this);
		}

		@Override
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof SqlGrammarListener) ((SqlGrammarListener) listener).exitTableNameWithHint(this);
		}

		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof SqlGrammarVisitor)
				return ((SqlGrammarVisitor<? extends T>) visitor).visitTableNameWithHint(this);
			else return visitor.visitChildren(this);
		}
	}

	public final TableNameWithHintContext tableNameWithHint() throws RecognitionException {
		TableNameWithHintContext _localctx = new TableNameWithHintContext(_ctx, getState());
		enterRule(_localctx, 54, RULE_tableNameWithHint);
		try {
			enterOuterAlt(_localctx, 1);
			{
				setState(539);
